...
import { AUTHOR, cN, SITE_DESCRIPTION, THUMBNAIL_URL } from "@/lib"
  ...
  .init({
    ...
    backend: {
      ...
      backendOptions: [
        ...
        {
          // UI strings now ship with the frontend, generated by the bekoffice-v2
          // seed (scripts/seed-impl.ts). Localized content fields come from
